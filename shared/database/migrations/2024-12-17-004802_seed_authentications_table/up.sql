...
VALUES (
        ...
        'https://oauth2.googleapis.com/token?client_id={ client_id }&client_secret={ client_secret }&grant_type=authorization_code&code={ code }&redirect_uri={ redirect_uri }',
    ...
    (
        ...
        'https://login.microsoftonline.com/common/oauth2/v2.0/token?client_id={ client_id }&client_secret={ client_secret }&grant_type=authorization_code&code={ code }&redirect_uri={ redirect_uri }',
    ...
    (
        ...
        'https://discord.com/api/oauth2/token?client_id={ client_id }&client_secret={ client_secret }&grant_type=authorization_code&code={ code }&redirect_uri={ redirect_uri }',
        '1326172743338561667',
