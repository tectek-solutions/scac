...
#[get("/workflows/{id}")]
async fn list_triggers_by_worflows_id(db: web::Data<database::Database>, id: web::Path<i32>) -> impl Responder {
    match query::list_triggers_by_worflows_id_query(&db, id.into_inner()) {
...
async fn get_trigger_by_id(
    ...
    match query::get_trigger_by_id_query(&db, id.into_inner()) {
